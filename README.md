...
XGBoost
(Ensemble)	0.9961	0.9980	0.9964	0.9994	0.9979	0.9719
...
XGBoost
(Ensemble)	Delivered the best overall results with the highest accuracy, AUC, and MCC, effectively capturing nonlinear relationships through boosting.
